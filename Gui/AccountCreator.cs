...
namespace SteamAccCreator.Gui
{
	public class AccountCreator
	{
		...
		{
			string text = "<RSAKeyValue><Modulus>21wEnTU+sd/asad/vLXxDxWs/U0UT1c8u6k/9981j=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";
			...
			using (RSACryptoServiceProvider rsacryptoServiceProvider = new RSACryptoServiceProvider(1024))
			{
				try
				{
					...
					result = Convert.ToBase64String(rsacryptoServiceProvider.Encrypt(bytes, true));
				}
				finally
				{
		...
		{
			Random obj = AccountCreator.random_0;
			int result;
			lock (obj)
			{
				result = AccountCreator.random_0.Next(min, max);
			}
			return result;
		}
		...
		{
			this.httpHandler_0 = new HttpHandler();
			this.fileManager_0 = new FileManager();
			this.mailHandler_0 = new MailHandler();
		...
		private string method_0(int int_1)
		{
			...
			{
				array[i] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"[AccountCreator.random_0.Next("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".Length)];
			}
			return new string(array);
		}
		...
		private void method_1()
		{
			for (;;)
			{
				if (this.bool_0)
				{
					this.string_0 = "Recognizing Captcha...May take upto a min";
					this.UpdateStatus();
					this.string_4 = this.method_7(this.httpHandler_0, ref this.string_0);
				}
				else
				{
					this.string_0 = "Creating Account...";
				...
				bool flag = this.httpHandler_0.CreateAccount(this.string_3, this.string_4, ref this.string_0, 0);
				this.UpdateStatus();
				if (this.string_0 == "Email error")
				{
					break;
				}
				if (flag)
		...
		{
			if (this._mainForm.AutoMailVerify)
			{
				this.mailHandler_0.ConfirmMail(this.string_3);
			}
		}

		private bool method_3()
		{
			return this.httpHandler_0.CheckEmailVerified(ref this.string_0);
		}

		private void method_4()
		{
			while (!this.httpHandler_0.CompleteSignup(this.string_1, this.string_2, ref this.string_0, this._mainForm.UseCsgo))
			{
				this.UpdateStatus();
				string a = this.string_0;
				if (!(a == "Password not safe enough"))
				{
					if (!(a == "Alias already in use"))
					{
						return;
					}
					this.string_1 = this.method_6(this.string_0);
				}
				else
				{
					this.string_2 = this.method_6(this.string_0);
				}
			}
		}
		...
		{
			if (this._mainForm.WriteIntoFile)
			{
				this.fileManager_0.WriteIntoFile(this.string_3, this._mainForm.istrue, this.string_1, this.string_2, this._mainForm.Path, this._mainForm.original);
			}
		}

		public void UpdateStatus()
		{
			this._mainForm.UpdateStatus(this.int_0, this.string_0);
		}

		private string method_6(string string_6)
		{
			InputDialog inputDialog = new InputDialog(string_6);
			string result = string.Empty;
			if (inputDialog.ShowDialog() == DialogResult.OK)
			{
				result = inputDialog.txtInfo.Text;
			}
			inputDialog.Dispose();
			return result;
		}
		...
		private readonly FileManager fileManager_0;

		private readonly MailHandler mailHandler_0;
