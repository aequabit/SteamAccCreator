...
namespace SteamAccCreator.Web
{
	public class Error
	{
		public const string WRONG_CAPTCHA = "Wrong captcha....Trying Again";
		...
		public const string TRASH_MAIL = "It appears you've entered a disposable email address, or are using an email provider that cannot be used on Steam. Please provide a different email address.";
